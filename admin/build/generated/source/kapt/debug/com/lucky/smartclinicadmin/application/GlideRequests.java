...
public class GlideRequests extends RequestManager {
  ...
  protected void setRequestOptions(@NonNull RequestOptions toSet) {
    if (toSet instanceof com.lucky.smartclinicadmin.application.GlideOptions) {
      super.setRequestOptions(toSet);
    } else {
      super.setRequestOptions(new com.lucky.smartclinicadmin.application.GlideOptions().apply(toSet));
    }
  }
}
