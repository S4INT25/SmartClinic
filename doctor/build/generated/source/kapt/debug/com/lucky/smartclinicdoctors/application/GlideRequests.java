...
public class GlideRequests extends RequestManager {
  ...
  protected void setRequestOptions(@NonNull RequestOptions toSet) {
    if (toSet instanceof com.lucky.smartclinicdoctors.application.GlideOptions) {
      super.setRequestOptions(toSet);
    } else {
      super.setRequestOptions(new com.lucky.smartclinicdoctors.application.GlideOptions().apply(toSet));
    }
  }
}
