...
public class DoctorProfileFragmentDirections {
  ...
  @NonNull
  public static ActionDoctorProfileFragmentToChatFragment actionDoctorProfileFragmentToChatFragment(
      @NonNull Doctor doctor) {
    return new ActionDoctorProfileFragmentToChatFragment(doctor);
  }

  public static class ActionDoctorProfileFragmentToChatFragment implements NavDirections {
    private final HashMap arguments = new HashMap();

    private ActionDoctorProfileFragmentToChatFragment(@NonNull Doctor doctor) {
      if (doctor == null) {
    ...
    @NonNull
    public ActionDoctorProfileFragmentToChatFragment setDoctor(@NonNull Doctor doctor) {
      if (doctor == null) {
        throw new IllegalArgumentException("Argument \"doctor\" is marked as non-null but was passed a null value.");
      }
      this.arguments.put("doctor", doctor);
    ...
    public int getActionId() {
      return R.id.action_doctorProfileFragment_to_chatFragment;
    }
    ...
    public boolean equals(Object object) {
      ...
      ActionDoctorProfileFragmentToChatFragment that = (ActionDoctorProfileFragmentToChatFragment) object;
    ...
    public String toString() {
      return "ActionDoctorProfileFragmentToChatFragment(actionId=" + getActionId() + "){"
          + "doctor=" + getDoctor()
          + "}";
    }
  }
