package com.lucky.smartclinic.application;
...
public class GlideRequests extends RequestManager {
  ...
  protected void setRequestOptions(@NonNull RequestOptions toSet) {
    if (toSet instanceof com.lucky.smartclinic.application.GlideOptions) {
      super.setRequestOptions(toSet);
    } else {
      super.setRequestOptions(new com.lucky.smartclinic.application.GlideOptions().apply(toSet));
    }
  }
}
